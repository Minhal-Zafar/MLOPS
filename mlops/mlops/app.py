...
def home():
    ...
    return render_template("chart.html", predicted=predicted, values=values, nextPrediction=nextDayPrediction, meanSquareError=meanSquareError, meanAbsoluteError=meanAbsoluteError)
